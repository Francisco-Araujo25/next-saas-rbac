...
export function PendingInvites() {
    // Correção: queryClient é um hook, precisa de ()
                    ...
                    return (
                        <div className="space-y-2" key={invite.id}>
                            ...
                            <div className="flex gap-1">
                                {/* Correção: handleAcceptInvite definido mas não usado */}
                                <Button onClick={() => handleAcceptInvite(invite.id)} size="xs" variant="outline">
                                    <Check className="size-2 mr-1.5" />
                                    Accept
                                </Button>

                                {/* Correção: handleRejectInvite definido mas não usado */}
